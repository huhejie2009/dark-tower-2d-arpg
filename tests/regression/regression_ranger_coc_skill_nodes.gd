...
func _run() -> void:
	...
	_expect(int(player.get("skill_points", -1)) == 3, "upgrades should spend three skill points")
	...
	_expect(int(reset.get("refunded_skill_points", 0)) == 3, "reset should refund spent points")
